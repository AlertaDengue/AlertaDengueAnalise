...
RJ.metropol1 <- list(pdig = c(2.997765,0.7859499),tcrit = tcrit.def, inccrit = inc.def)
RJ.metropol2 <- list(pdig = c(2.997765,0.7859499),tcrit = tcrit.def, inccrit = inc.def)
