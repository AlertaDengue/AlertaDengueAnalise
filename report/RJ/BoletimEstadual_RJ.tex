...
\textbf{Semana 39 de 2016} % se, ano, em pp.RData
...
Desde o início do ano, 105293 casos foram registrados no estado, sendo 50 na última semana. A figura abaixo mostra as condições de transmissão em cada município.

% Mapa estadual
\includegraphics[width=0.8\textwidth]{figs/Mapa_ERJ.png}
%-----------------------------------------------------------

Dos 92 municipios, 92 encontram-se em nivel verde, 0 em nivel amarelo, 0 em nivel laranja e 0 em nivel vermelho referentes a semana epidemiológica 39-2016. Para informações mais atualizadas
...
%-----------------------------------------------------------------------------------
 %\begin{minipage}[t]{1\linewidth} % Mini page taking up 100% of the actual page
      ...
      \hypertarget{municips}{\heading{Resumo da situação epidemiológica da dengue nos municípios de Rio de Janeiro, na semana 39 de 2016}{6pt}}
