...
\textbf{Semana 37 de 2016} % se, ano, em pp.RData
...
Desde o início do ano, 103542 casos foram registrados no estado, sendo 110 na última semana. A figura abaixo mostra as condições de transmissão em cada município.
...
%-----------------------------------------------------------------------------------
 %\begin{minipage}[t]{1\linewidth} % Mini page taking up 100% of the actual page
      ...
      \hypertarget{municips}{\heading{Resumo da situação epidemiológica da dengue nos municípios de Rio de Janeiro, na semana 37 de 2016}{6pt}}
