...
\textbf{Semana 40 de 2016} % se, ano, em pp.RData
...
%-----------------------------------------------------------------------------------
 %\begin{minipage}[t]{1\linewidth} % Mini page taking up 100% of the actual page
      ...
      \hypertarget{municips}{\heading{Resumo da situação epidemiológica da dengue nos municípios de Rio de Janeiro, na semana 40 de 2016}{6pt}}
