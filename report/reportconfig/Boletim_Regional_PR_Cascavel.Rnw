%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Boletim semanal municipal do InfoDengue - Adapted by Claudia Codeco (Jun 2016)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Boletim readaptado para a Regional de Saúde de Cascavel/PR 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\documentclass[10pt]{article} % The default font size is 10pt; 11pt and 12pt are alternatives
\SweaveOpts{keep.source=TRUE}
\input{~/AlertaDengueAnalise/report/reportconfig/structure_infodengue.tex} % Include the document which specifies all packages and structural customizations for this template ../reportconfig/
...
load('~/AlertaDengueAnalise/report/PR/Regionais/Cascavel/figs/paramsPR.RData') #parametros do estado e regionais 
load('~/AlertaDengueAnalise/report/PR/Regionais/Cascavel/paramsCascavel.RData') # parametros do municipio

figmapaestado = paste('~/AlertaDengueAnalise/report/PR/figs/','Mapa_E',sigla,'.png',sep='')
figmunicipio = '~AlertaDengueAnalise/report/PR/Regionais/Cascavel/figs/figuraCascavel.RData'
@


\fancyfoot[C]{Boletim 10ªRS - Cascavel } 
\fancyfoot[R]{SE \Sexpr{se} de \Sexpr{ano}}
...
Dos \Sexpr{nmunicipios} municipios, \Sexpr{nverde} encontram-se em nivel verde, \Sexpr{namarelo} em nivel amarelo, \Sexpr{nlaranja} em nivel laranja e \Sexpr{nvermelho} em nivel vermelho referentes a semana epidemiológica \Sexpr{se}-\Sexpr{ano}. Para informações mais atualizadas
sobre olocalidade monitoradas consultar em \href{http://info.dengue.mat.br}{\textit{Info Dengue}}.
...
i  = which(regs==as.character("Cascavel"))  
      cat('\\begin{minipage}[t]{.66\\linewidth}\n')  # inicio da minipage
      # titulo:
      cat(paste('\\hypertarget{',nickregs[[i]],'}{\\heading{Situação da Dengue na Regional ',regs[i],'}{6pt}}\n',sep='')); 
      
      # Mapa:
      nomesemespaco = gsub(' ','', regs[i])
      nomesemacento = iconv(nomesemespaco, to = 'ASCII//TRANSLIT')
      #mapareg=paste(sigla,'/figs/Mapa',sigla,'_',nomesemacento,'.png',sep='')
      mapareg=paste('../report/PR/Regionais/Cascavel/figs/MapaPR_Cascavel.png',sigla,'_',nomesemacento,'.png',sep='')
      #cat(paste('\\includegraphics[width=0.8\\textwidth]{',mapareg,'}',sep=''))
      cat(paste('\\includegraphics[\\width=8\\textwidth]{',mapareg,'}\n',sep=''));
      #cat('\\vspace{0.5cm}')
      
      # Tabela 
      #tabreg=paste(sigla,'/figs/','tabregional',sigla,'_',nomesemacento,
      #             '.tex',sep='')
      tabreg=paste('../report/PR/Regionais/Cascavel/figs/',
                   'tabregional',sigla,'_',nomesemacento, '.tex',sep='')
      
      cat(paste('\\captionof{table}[tabregional]{Resumo das últimas seis semanas epidemiológicas na Regional',regs[i],'}\n'))
      cat('\\begin{center}\n')
      ...
      # Grafico regional:
      figname = paste('../report/PR/REgionais/Cascavel/figs/tweet',sigla,'_',nomesemacento,'.png',sep='')
      #figname = paste(sigla,'/figs/tweet',sigla,'_',nomesemacento,'.png',sep='')
      #cat('\\vspace{0.5cm}')
      cat('\\begin{center}\n')
      ...
      cat(paste('\\includegraphics[width=1.3\\textwidth]{',figname,'}\n',sep=''))
      cat('\\end{center}\n')
...
\hypertarget{municipio}{\heading{Situação da Dengue na cidade de Cascavel}{6pt}} 


Desde o início do ano, \Sexpr{totanomun} casos foram registrados na cidade, sendo \Sexpr{totultsemun} na última semana. 

A cidade encontra-se em \textbf{nivel \Sexpr{nivelmun}}. 
...
\includegraphics[width=1\textwidth]{\Sexpr{figmunicipio}}
