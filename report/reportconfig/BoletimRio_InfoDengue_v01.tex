...
\textbf{Semana 22 de 2016} % se, ano, em pp.RData
...
\input{../Rio_de_Janeiro/tabela1.tex}
\captionof{table}{APS 2.1 }
\input{../Rio_de_Janeiro/tabela2.tex}
\captionof{table}{APS 2.2 }
\input{../Rio_de_Janeiro/tabela3.tex}
\captionof{table}{APS 3.1 }
\input{../Rio_de_Janeiro/tabela4.tex}
\captionof{table}{APS 3.2 }
\input{../Rio_de_Janeiro/tabela5.tex}\end{center}\small{\hyperlink{vartab}{ver descrição das variáveis}}(cont.)
\newpage
...
\input{../Rio_de_Janeiro/tabela6.tex}
\captionof{table}{APS 4.0 }
\input{../Rio_de_Janeiro/tabela7.tex}
\captionof{table}{APS 5.1 }
\input{../Rio_de_Janeiro/tabela8.tex}
\captionof{table}{APS 5.2 }
\input{../Rio_de_Janeiro/tabela9.tex}
\captionof{table}{APS 5.3 }
\input{../Rio_de_Janeiro/tabela10.tex}\end{center}\small{\hyperlink{vartab}{ver descrição das variáveis}}
%---------------------------------------------------------------------------------
