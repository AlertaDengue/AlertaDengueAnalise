...
e ter acesso ao mapa interativo do estado consultar \href{http://info.dengue.mat.br}{\textit{Info Dengue}}.
...
% Mapa da regional
\vspace{2cm}
\captionof{table}[tabregional]{Mapa de Alerta da Regional de Saúde}
\begin{center}
