...
Dos \Sexpr{env$nmunicipios} municipios, \Sexpr{env$nverdeUF} encontram-se em nivel verde, \Sexpr{env$namareloUF} em nivel amarelo, \Sexpr{env$nlaranjaUF} em nivel laranja e \Sexpr{env$nvermelhoUF} em nivel vermelho. Para informações mais atualizadas e ter acesso ao mapa interativo do estado e de outras localidades, consultar em \href{http://info.dengue.mat.br}{\textit{Info Dengue}}.
...
% Mapa da regional
\vspace{2cm}
\captionof{figure}{Mapa de Alerta da Regional de Saúde} %{table}[tabregional]
\begin{center}
...
% tabela da regional 
\captionof{table}[tabregional]{Resumo das últimas seis semanas epidemiológicas na Regional \Sexpr{env$regional}}
\begin{center}
