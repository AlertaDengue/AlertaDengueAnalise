...
\item \hyperlink{munC}{Chikungunia no Município}
...
Em 2017, até agora, foram notificados \Sexpr{env$tot2017} casos de dengue na cidade do Rio de Janeiro. Para comparação, em 2016, no mesmo período, \Sexpr{env$tot2016se} casos de dengue foram notificados. No total, em 2016, ocorreram \Sexpr{env$tot2016} casos. 
...
%-----------------------------------------------------------------------------------%	
  % MAIN BODY - FIFTH PAGE - Situação da chikungunia na cidade: SÉRIE HISTÓRICA e MAPA
%-----------------------------------------------------------------------------------

\begin{minipage}[t]{0.6\linewidth} % Mini page taking up 100% of the actual page
\hypertarget{munC}{\heading{Situação da Chikungunia na Cidade do Rio de Janeiro}{6pt}} % \hypertarget 

Em 2017, até agora, foram notificados \Sexpr{env$totChik2017} casos de chikungunia na cidade do Rio de Janeiro, sendo \Sexpr{env$totChik2017ult} na última semana. Para comparação, em 2016, no mesmo período, \Sexpr{env$totChik2016se} casos de chikungunia foram notificados na cidade do Rio de Janeiro. No total, em 2016, ocorreram \Sexpr{env$totChik2016} casos. 

Veja o mapa da situação atual de transmissão de chikungunia nas APS:

\includegraphics[width=0.95\textwidth]{\Sexpr{env$nomemaparioChik}}


Confira a série histórica de chikungunia na cidade do Rio de Janeiro desde janeiro de 2016.
...
\hypertarget{aps}{\heading{Nas Áreas Programáticas de Saúde: Chikungunia}{6pt}} % \hypertarget 
...
\heading{Tabelas: Resumo das últimas quatro semanas epidemiológicas da dengue e chikungunia nas APS.}{6pt}
