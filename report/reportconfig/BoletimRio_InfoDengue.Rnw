...
Em 2018, até agora, foram notificados \Sexpr{env$tot2018} casos de dengue na cidade do Rio de Janeiro. Para comparação, em 2017, no mesmo período, \Sexpr{env$tot2017se} casos de dengue foram notificados. No total, em 2017, ocorreram \Sexpr{env$tot2017} casos. 
...
Em 2018, até agora, foram notificados \Sexpr{env$totChik2018} casos de chikungunya na cidade do Rio de Janeiro, sendo \Sexpr{env$totChik2018ult} na última semana. Para comparação, em 2017, no mesmo período, \Sexpr{env$totChik2017se} casos de chikungunya foram notificados na cidade do Rio de Janeiro. No total, em 2017, ocorreram \Sexpr{env$totChik2017} casos. 
...
Confira a série histórica de chikungunya na cidade do Rio de Janeiro desde janeiro de 2017.
