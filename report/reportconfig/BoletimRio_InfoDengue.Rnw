...
Em 2017, até agora, foram notificados \Sexpr{env$totChik2017} casos de chikungunya na cidade do Rio de Janeiro, sendo \Sexpr{env$totChik2017ult} na última semana. Para comparação, em 2016, no mesmo período, \Sexpr{env$totChik2016se} casos de chikungunya foram notificados na cidade do Rio de Janeiro. No total, em 2016, ocorreram \Sexpr{env$totChik2016} casos. 
...
Confira a série histórica de chikungunya na cidade do Rio de Janeiro desde janeiro de 2016.
