...
Dos \Sexpr{nmunicipios} municipios, \Sexpr{nverde} encontram-se em nivel verde, \Sexpr{namarelo} em nivel amarelo, \Sexpr{nlaranja} em nivel laranja e \Sexpr{nvermelho} em nivel vermelho referentes a semana epidemiológica \Sexpr{se}-\Sexpr{ano}. Para informações sobre outros municípios e ter acesso aos seus mapas interativos consultar em \href{http://info.dengue.mat.br}{\textit{Info Dengue}}.
...
\item Secretaria de Estado de Saúde do Distrito Federal.
\end{itemize}
