...
for (i in 1:1){
      ...
      # Mapa:
      #mapareg = paste(pathrelatorio,"figs/mapa",sigla,"_",regs[i],".png",sep="")
      #mapareg = paste(sigla,"/figs/mapa",sigla,"_",nomereg,".png",sep="")
...
#              linksite <- paste("https://alerta.dengue.mat.br/alerta/",
#                                municip.reg$municipio_geocodigo[j],sep="")
#              cat(paste("\\item \\hyperlink{",linksite,"}{",municip.reg$nome[j],"}\n",sep=""))
#        }
#        cat("\\end{itemize}")
#  
