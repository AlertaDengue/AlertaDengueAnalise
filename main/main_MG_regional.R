...
geraMapa(alerta=aleMG_RS_SeteLagoas, se=data_relatorio, shapefile = MG.shape,   
         varid=MG.shapeID, titulo="", 
         filename=paste("Mapa_E", "MG",".png", sep=""),
         dir=MG.out, caption=FALSE)
