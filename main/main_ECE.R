...
ale.F.den <- pipe_infodengue(2304400, cid10 = "A90", nowcasting = "fixedprob", finalday = new_data_relatorio)
ale.F.chik <- pipe_infodengue(2304400, cid10 = "A92.0", nowcasting = "fixedprob", finalday = new_data_relatorio)
