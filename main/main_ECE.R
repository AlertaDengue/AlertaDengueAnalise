...
ale.F.den <- pipe_infodengue(2304400, cid10 = "A90", nowcasting = "fixedprob", finalday = dia_relatorio, userinput = TRUE); save(ale.F.den,file = "aleFden.RData")
ale.F.chik <- pipe_infodengue(2304400, cid10 = "A92.0", nowcasting = "fixedprob", finalday = dia_relatorio, userinput = TRUE); save(ale.F.chik,file = "aleFchik.RData")
ale.F.zika <- pipe_infodengue(2304400, cid10 = "A92.8", nowcasting = "fixedprob", finalday = dia_relatorio, userinput = TRUE); save(ale.F.zika,file = "aleFzika.RData")
