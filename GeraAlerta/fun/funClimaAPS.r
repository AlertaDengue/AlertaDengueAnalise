...
#### Funções a serem incorporadas no Alerta dengue ##
...
# jor=as.Date("2010-01-03") : primeira semana epidemiologica de 2010

clima.hora2dia <-function(d,estacao="Centro",jor=as.Date("2010-01-03")){
...
listaAPS <- list(APS1 = c("Centro","Sao Cristovao"), APS2.1 = "Copacabana", APS2.2 = "Tijuca", APS3.1 = c("Centro","Iraja"),
                 APS3.2 = c("Centro","Tijuca"),APS3.3="Iraja",APS4="Pedra de Guaratiba",APS5.1="Bangu",APS5.2="Campo Grande",
                 APS5.3 = "Campo Grande")
...
boxplot(tmin~localizacao,data=dfull,las=2,main="tmin")
boxplot(umed~localizacao,data=dfull,las=2,main="umed")

par(mfrow=c(1,1),mar=c(6,4,2,1))
barplot(tapply(dfull$mmchuva,dfull$localizacao,sum,na.rm=TRUE),las=2)
barplot(tapply(dfull$horaschuva,dfull$localizacao,sum,na.rm=TRUE),las=2,main="dias de chuva")
#AP1
par(mfrow=c(2,2),mar=c(2,2,2,2))
